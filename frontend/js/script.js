...
function displayFeaturedNews(articles) {
    ...
    container.innerHTML = articles.map((article, index) => `
        <div class="featured-card" onclick='openArticle(${JSON.stringify(article).replace(/'/g, "\\'")})'
            ...
            <img src="${article.urlToImage || `https://via.placeholder.com/600x400/e74c3c/fff?text=Delhi+News`}" 
                 alt="${article.title}"
                 onerror="this.src='https://via.placeholder.com/600x400/e74c3c/fff?text=Delhi+Samachar'">
    ...
    articles.forEach((article, index) => {
        ...
        card.innerHTML = `
            <div class="card-image">
                <img src="${article.urlToImage || `https://via.placeholder.com/400x200/${getRandomColor()}/fff?text=${encodeURIComponent(source)}`}" 
                     alt="${article.title}"
                     loading="lazy"
                     onerror="this.src='https://via.placeholder.com/400x200/e74c3c/fff?text=Delhi+News'">
    ...
    const demoArticles = [
        {
            ...
            urlToImage: "https://via.placeholder.com/600x400/e74c3c/fff?text=Delhi+Heat+Wave",
        ...
        },
        {
            ...
            urlToImage: "https://via.placeholder.com/600x400/3498db/fff?text=Delhi+Metro+News",
        ...
        },
        {
            ...
            urlToImage: "https://via.placeholder.com/600x400/c0392b/fff?text=Delhi+Crime",
        ...
        },
        {
            ...
            urlToImage: "https://via.placeholder.com/600x400/27ae60/fff?text=Delhi+Government",
        ...
        },
        {
            ...
            urlToImage: "https://via.placeholder.com/600x400/f39c12/fff?text=Delhi+Traffic",
        ...
        },
        {
            ...
            urlToImage: "https://via.placeholder.com/600x400/8e44ad/fff?text=Delhi+AQI",
        ...
        },
        {
            ...
            urlToImage: "https://via.placeholder.com/600x400/1abc9c/fff?text=DU+Admission",
        ...
        },
        {
            ...
            urlToImage: "https://via.placeholder.com/600x400/e67e22/fff?text=Chandni+Chowk",
